...
$text = "";
$link = "https://cdn.trustindex.io/assets/platform/".ucfirst("sourceForge")."/star/";
if (!is_numeric($score)) {
return $text;
}
...
<?php echo $pluginManagerInstance->getProFeatureButton('wp-sourceForge-pro'); ?>
</div>
...
<td class="ti-text-center source-<?php echo ucfirst("sourceForge") ?>"><?php echo trustindex_plugin_write_rating_stars($review->rating); ?></td>
...
<?php endif; ?>
<a href="<?php echo esc_attr($review->id); ?>" data-nonce="<?php echo wp_create_nonce('ti-save-reply'); ?>" class="ti-btn ti-btn-sm btn-post-reply"><?php echo sprintf(__('Upload reply to %s', 'trustindex-plugin'), 'SourceForge'); ?></a>
...
<?php endif; ?>
<?php
$tiCampaign1 = 'wp-sourceForge-4';
$tiCampaign2 = 'wp-sourceForge-5';
