...
$stepList = [
sprintf(__('Connect %s', 'trustindex-plugin'), 'SourceForge'),
...
<h1 class="ti-header-title"><?php echo sprintf(__('Connect %s', 'trustindex-plugin'), 'SourceForge'); ?></h1>
...
<?php else: ?>
<div class="ti-box">
<form method="post" action="" data-platform="sourceForge" id="ti-connect-platform-form">
...
$labelText = sprintf(__('%s Business URL', 'trustindex-plugin'), 'SourceForge');
$infoText = __("Type your business/company's URL and select from the list", 'trustindex-plugin');
$errorText = sprintf(__('Please add your URL again: this is not a valid %s page.', 'trustindex-plugin'), "SourceForge");
...
<?php endif; ?>
<h1 class="ti-header-title ti-mt-2"><?php echo sprintf(__('Check some %s widget layouts and styles', 'trustindex-plugin'), 'SourceForge reviews'); ?></h1>
...
<p>
<?php echo sprintf(__('There are no reviews on your %s platform.', 'trustindex-plugin'), 'SourceForge'); ?>
</p>
</div>
<?php endif; ?>
...
<?php endif; ?>
<?php
$tiCampaign1 = 'wp-sourceForge-1';
$tiCampaign2 = 'wp-sourceForge-2';
