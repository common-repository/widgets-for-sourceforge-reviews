<?php
class TrustindexPlugin_sourceForge
{
...
$chosedPlatform = new $className($forcePlatform, $filePath, "do-not-care-12.4.1", "do-not-care-Widgets for SourceForge Reviews", "do-not-care-SourceForge");
