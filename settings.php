...
$pluginManager = 'TrustindexPlugin_sourceForge';
$pluginManagerInstance = $trustindex_pm_sourceForge;
$pluginNameForEmails = 'SourceForge';
$newBadgeTabs = [];
...
$logoCampaignId = 'wp-sourceForge-l';
...
$assetCheckCssId = 'trustindex_settings_style_sourceForge';
