...
$pluginManagerInstance = $trustindex_pm_sourceForge;
...
<p>
<a href="<?php echo admin_url("admin.php?page=widgets-for-sourceforge-reviews/settings.php&wc_notification=open"); ?>" target="_blank" class="trustindex-rateus" style="text-decoration: none">
<button class="button button-primary"><?php echo __('Download plugin', 'trustindex-plugin'); ?></button>
</a>
<a href="<?php echo admin_url("admin.php?page=widgets-for-sourceforge-reviews/settings.php&wc_notification=hide"); ?>" class="trustindex-rateus" style="text-decoration: none">
